...
class Ui_NoteWindow(object):
    def setupUi(self, NoteWindow):
        ...
        self.spacer = QtWidgets.QWidget(self.NoteWindow_2)
...
"border-color: rgb(15, 76, 117);")
        ...
        self.closeButton.setStyleSheet("color: rgb(50, 130, 184);")
...
"")
    ...
    def retranslateUi(self, NoteWindow):
        ...
        self.closeButton.setText(_translate("NoteWindow", "r"))
